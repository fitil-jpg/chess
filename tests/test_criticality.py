...
def test_knight_two_move_fork_detected_and_neutralised():
    # Add a pawn on d2 to block Qd4 and ensure capturing the g5 knight
    # remains the bot's optimal neutralising move.
    board = chess.Board("6k1/8/8/6n1/8/5N2/3PK3/3Q4 w - - 0 1")
